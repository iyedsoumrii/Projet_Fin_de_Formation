...
<html lang="fr">
    <head>
        <title>Bijoux Click - Voir la demande</title>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Voir les demandes</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="index.php">Accueil</a></li>
                            <li class="breadcrumb-item active">Voir les demandes</li>
                        </ol>
                        <div class="card mb-4">
                            <div class="card-body">
                                <?php
                                ...
                                ?>
                                    <table class="table table-bordered mg-b-0" style="font-size: 20px;">
                                        ...
                                        <tr>
                                            <th scope="row" style="font-size: 15px;">Nom</th>
                                            <td><?php echo $row['Name'];?></td>
                                            <th style="font-size: 15px;" scope="row">Email</th>
